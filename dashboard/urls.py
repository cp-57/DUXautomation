...
urlpatterns = [
    ...
    path('dashboard-step-two/<uuid:id>/', dashboard_step_two_view, name='dashboard-step-two'),
    path('dashboard-step-three/<uuid:id>/', dashboard_step_three_view, name='dashboard-step-three'),
